...
//	Net Communication Information
	IDIO_NET_TYPE_REGISTER_PROCESS			=	0,	//	Process is registered?
...
//	PWM Pulse Unit
	DIO_PWM_PULSE_UNIT_S					=	1,
	DIO_PWM_PULSE_UNIT_MS					=	2,
	DIO_PWM_PULSE_UNIT_US					=	3,
	DIO_PWM_PULSE_UNIT_NS					=	4,

//	PWM Pulse Phase Shift
	DIO_PWM_PULSE_PHASE_0_DEGREES			=	0,
	DIO_PWM_PULSE_PHASE_90_DEGREES			=	90,
	DIO_PWM_PULSE_PHASE_180_DEGREES			=	180,

//	Pulse Measurement Logic
	DIO_PULSE_MEASUREMENT_TARGET_OFF_TIME	=	0,
	DIO_PULSE_MEASUREMENT_TARGET_ON_TIME	=	1,

//	Pulse Measurement Time Unit
	DIO_PULSE_MEASUREMENT_TIME_UNIT_S		=	1,
	DIO_PULSE_MEASUREMENT_TIME_UNIT_MS		=	2,
	DIO_PULSE_MEASUREMENT_TIME_UNIT_US		=	3,
	DIO_PULSE_MEASUREMENT_TIME_UNIT_NS		=	4,
...
//	DIO
	...
	DIO_ERR_SYS_CH_NO						=	20105,	//	Channel No. is outside the setting range.
	DIO_ERR_SYS_CH_NUM						=	20106,	//	Channel number is outside the setting range.
	...
	DIO_ERR_SYS_CNT_EDGE					=	20700,	//	Count edge is outside the setting range.
	DIO_ERR_SYS_CMP_REG_NO					=	20800,	//	Comparision register No. is outside the setting range.
	DIO_ERR_SYS_CMP_REG_VAL					=	20801,	//	Comparision register value is outside the setting range.
	DIO_ERR_SYS_COUNT_VAL					=	20810,	//	Count value is outside the setting range.
	DIO_ERR_SYS_PWM_PULSE_PERIOD			=	20900,	//	The PWM pulse period is out of range.
	DIO_ERR_SYS_PWM_PERIOD_UNIT				=	20901,	//	The PWM pulse period unit is out of range.
	DIO_ERR_SYS_PWM_PULSE_DUTY				=	20902,	//	The PWM pulse duty ratio is out of range.
	DIO_ERR_SYS_PWM_PULSE_PHASE				=	20903,	//	The PWM pulse phase setting is out of range.
	DIO_ERR_SYS_PWM_RUNNING_PWM				=	20904,	//	Function is not allowed to be called during the PWM operation.
	DIO_ERR_SYS_PULSE_MEASUREMENT_TARGET	=	20950,	//	The pulse measurement time is out of range.
	DIO_ERR_SYS_PULSE_MEASUREMENT_PERIOD	=	20951,	//	The pulse measurement period is out of range.
	DIO_ERR_SYS_PULSE_MEASUREMENT_RUNNING	=	20952,	//	Function is not allowed to be called during the pulse measurement operation.
	DIO_ERR_SYS_PULSE_MEASUREMENT_TIME_UNIT	=	20953,	//	The pulse measurement time unit is out of range.
...
//	Module Information
	DIO_ERR_SYS_DEVICE_ERR_DRIVER_IC_ERR	=	21200,	//	Driver IC error occurred.
	DIO_ERR_SYS_DEVICE_ERR_PCOM_FAILURE		=	21201,	//	PCOM power failure occurred.
...
namespace CdioCs
{
	...
	public class Cdio
	{
		...
		[DllImport("cdio.dll")] static extern int DioInpByteSR(short Id, short PortNo, ref byte Data, ref ushort Timestamp, byte Mode);
        [DllImport("cdio.dll")] static extern int DioInpBitSR(short Id, short BitNo, ref byte Data, ref ushort Timestamp, byte Mode);
		...
		[DllImport("cdio.dll")] static extern int DioInpMultiByteSR(short Id, [MarshalAs(UnmanagedType.LPArray)] short[] PortNo, short PortNum, [MarshalAs(UnmanagedType.LPArray)] byte[] Data, ref ushort Timestamp, byte Mode);
		[DllImport("cdio.dll")] static extern int DioInpMultiBitSR(short Id, [MarshalAs(UnmanagedType.LPArray)] short[] BitNo, short BitNum, [MarshalAs(UnmanagedType.LPArray)] byte[] Data, ref ushort Timestamp, byte Mode);
		...
		// Interrupt functions
		[DllImport("cdio.dll")] static extern int DioNotifyInterrupt(short Id, short IntBit, short Logic, IntPtr hWnd);
		[DllImport("cdio.dll")] unsafe static extern int DioSetInterruptCallBackProc(short Id, IntPtr pIntCallBack, void *Param);
		
		// Trigger functions
		[DllImport("cdio.dll")] static extern int DioNotifyTrg(short Id, short TrgBit, short TrgKind, int Tim, IntPtr hWnd);
        ...
        [DllImport("cdio.dll")] static extern int DioGetNetCommunicationInfo(short Id, short InfoType, ref int InfoData);
        ...
        [DllImport("cdio.dll")] static extern int DioReadCountSR(short Id, [MarshalAs(UnmanagedType.LPArray)] short[] ChNo, short ChNum, [MarshalAs(UnmanagedType.LPArray)] uint[] Count, ref ushort Timestamp, byte Mode);

		// PWM function
		[DllImport("cdio.DLL")] static extern int DioGetMaxPwmChannels(short Id, ref ushort ChannelNum);
		[DllImport("cdio.DLL")] static extern int DioSetPwmPulsePeriod(short Id, [MarshalAs(UnmanagedType.LPArray)] short[] ChannelNo, short ChannelNum, [MarshalAs(UnmanagedType.LPArray)] ulong[] PulsePeriodValue, [MarshalAs(UnmanagedType.LPArray)] ushort[] PulsePeriodUnit);
		[DllImport("cdio.DLL")] static extern int DioGetPwmPulsePeriod(short Id, [MarshalAs(UnmanagedType.LPArray)] short[] ChannelNo, short ChannelNum, [MarshalAs(UnmanagedType.LPArray)] ulong[] PulsePeriodValue, [MarshalAs(UnmanagedType.LPArray)] ushort[] PulsePeriodUnit);
		[DllImport("cdio.DLL")] static extern int DioSetPwmPulseDuty(short Id, [MarshalAs(UnmanagedType.LPArray)] short[] ChannelNo, short ChannelNum, [MarshalAs(UnmanagedType.LPArray)] ushort[] PulseDuty);
		[DllImport("cdio.DLL")] static extern int DioGetPwmPulseDuty(short Id, [MarshalAs(UnmanagedType.LPArray)] short[] ChannelNo, short ChannelNum, [MarshalAs(UnmanagedType.LPArray)] ushort[] PulseDuty);
		[DllImport("cdio.DLL")] static extern int DioSetPwmPulsePhase(short Id, [MarshalAs(UnmanagedType.LPArray)] short[] ChannelNo, short ChannelNum, [MarshalAs(UnmanagedType.LPArray)] short[] PulsePhase);
		[DllImport("cdio.DLL")] static extern int DioGetPwmPulsePhase(short Id, [MarshalAs(UnmanagedType.LPArray)] short[] ChannelNo, short ChannelNum, [MarshalAs(UnmanagedType.LPArray)] short[] PulsePhase);
		[DllImport("cdio.DLL")] static extern int DioStartPwm(short Id, [MarshalAs(UnmanagedType.LPArray)] short[] ChannelNo, short ChannelNum);
		[DllImport("cdio.DLL")] static extern int DioStopPwm(short Id, [MarshalAs(UnmanagedType.LPArray)] short[] ChannelNo, short ChannelNum);
		[DllImport("cdio.DLL")] static extern int DioGetPwmStatus(short Id, [MarshalAs(UnmanagedType.LPArray)] short[] ChannelNo, short ChannelNum, [MarshalAs(UnmanagedType.LPArray)] ushort[] Status, [MarshalAs(UnmanagedType.LPArray)] ushort[] Error);

		// Pulse Monitor function
		[DllImport("cdio.DLL")] static extern int DioGetMaxPulseMeasurementChannels(short Id, ref ushort ChannelNum);
		[DllImport("cdio.DLL")] static extern int DioSetPulseMeasurementSetting(short Id, [MarshalAs(UnmanagedType.LPArray)] short[] ChannelNo, short ChannelNum, [MarshalAs(UnmanagedType.LPArray)] ushort[] MeasurementTarget, [MarshalAs(UnmanagedType.LPArray)] ushort[] PulsePeriod);
		[DllImport("cdio.DLL")] static extern int DioGetPulseMeasurementSetting(short Id, [MarshalAs(UnmanagedType.LPArray)] short[] ChannelNo, short ChannelNum, [MarshalAs(UnmanagedType.LPArray)] ushort[] MeasurementTarget, [MarshalAs(UnmanagedType.LPArray)] ushort[] PulsePeriod);
		[DllImport("cdio.DLL")] static extern int DioStartPulseMeasurement(short Id, [MarshalAs(UnmanagedType.LPArray)] short[] ChannelNo, short ChannelNum);
		[DllImport("cdio.DLL")] static extern int DioStopPulseMeasurement(short Id, [MarshalAs(UnmanagedType.LPArray)] short[] ChannelNo, short ChannelNum);
		[DllImport("cdio.DLL")] static extern int DioReadPulseMeasurementData(short Id, [MarshalAs(UnmanagedType.LPArray)] short[] ChannelNo, short ChannelNum, [MarshalAs(UnmanagedType.LPArray)] ushort[] Status, [MarshalAs(UnmanagedType.LPArray)] ushort[] Error, [MarshalAs(UnmanagedType.LPArray)] ulong[] TimeValue, [MarshalAs(UnmanagedType.LPArray)] ushort[] TimeUnit);
		...
		[DllImport("cdio.DLL")] static extern int DioDmSetStopEvent(short Id, short Direction, IntPtr hWnd);
		[DllImport("cdio.DLL")] unsafe static extern int DioDmSetStopCallBackProc(short Id, IntPtr CallBackProc, void *Param);
		[DllImport("cdio.DLL")] static extern int DioDmSetCountEvent(short Id, short Direction, uint Count, IntPtr hWnd);
        ...
        public int InpByteSR(short Id, short PortNo, out byte Data, out ushort Timestamp, byte Mode)
        {
            Data = 0;
            Timestamp = 0;
            int ret = DioInpByteSR(Id, PortNo, ref Data, ref Timestamp, Mode);
            return ret;
        }

        public int InpBitSR(short Id, short BitNo, out byte Data, out ushort Timestamp, byte Mode)
        {
            Data = 0;
            Timestamp = 0;
            int ret = DioInpBitSR(Id, BitNo, ref Data, ref Timestamp, Mode);
            return ret;
        }
        ...
        public int InpMultiByteSR(short Id, short[] PortNo, short PortNum, byte[] Data, out ushort Timestamp, byte Mode)
        {
            Timestamp = 0;
            int ret = DioInpMultiByteSR(Id, PortNo, PortNum, Data, ref Timestamp, Mode);
            return ret;
        }

        public int InpMultiBitSR(short Id, short[] BitNo, short BitNum, byte[] Data, out ushort Timestamp, byte Mode)
        {
            Timestamp = 0;
            int ret = DioInpMultiBitSR(Id, BitNo, BitNum, Data, ref Timestamp, Mode);
            return ret;
        }
		...
		// Interrupt functions
		public int NotifyInterrupt(short Id, short IntBit, short Logic, IntPtr hWnd)
		{
		...
		// Trigger functions
		public int NotifyTrg(short Id, short TrgBit, short TrgKind, int Tim, IntPtr hWnd)
		{
        ...
        public int GetNetCommunicationInfo(short Id, short InfoType, out int InfoData)
        {
            InfoData = 0;
            int ret = DioGetNetCommunicationInfo(Id, InfoType, ref InfoData);
            return ret;
        }
		...
		public int GetMaxPwmChannels(short Id, out ushort ChannelNum)
		{
			ChannelNum = 0;
			int ret = DioGetMaxPwmChannels(Id, ref ChannelNum);
			return ret;
		}

		public int SetPwmPulsePeriod(short Id, short[] ChannelNo, short ChannelNum, ulong[] PulsePeriodValue, ushort[] PulsePeriodUnit)
		{
			int ret = DioSetPwmPulsePeriod(Id, ChannelNo, ChannelNum, PulsePeriodValue, PulsePeriodUnit);
			return ret;
		}

		public int GetPwmPulsePeriod(short Id, short[] ChannelNo, short ChannelNum, ulong[] PulsePeriodValue, ushort[] PulsePeriodUnit)
		{
			int ret = DioGetPwmPulsePeriod(Id, ChannelNo, ChannelNum, PulsePeriodValue, PulsePeriodUnit);
			return ret;
		}

		public int SetPwmPulseDuty(short Id, short[] ChannelNo, short ChannelNum, ushort[] PulseDuty)
		{
			int ret = DioSetPwmPulseDuty(Id, ChannelNo, ChannelNum, PulseDuty);
			return ret;
		}

		public int GetPwmPulseDuty(short Id, short[] ChannelNo, short ChannelNum, ushort[] PulseDuty)
		{
			int ret = DioGetPwmPulseDuty(Id, ChannelNo, ChannelNum, PulseDuty);
			return ret;
		}

		public int SetPwmPulsePhase(short Id, short[] ChannelNo, short ChannelNum, short[] PulsePhase)
		{
			int ret = DioSetPwmPulsePhase(Id, ChannelNo, ChannelNum, PulsePhase);
			return ret;
		}

		public int GetPwmPulsePhase(short Id, short[] ChannelNo, short ChannelNum, short[] PulsePhase)
		{
			int ret = DioGetPwmPulsePhase(Id, ChannelNo, ChannelNum, PulsePhase);
			return ret;
		}

		public int StartPwm(short Id, short[] ChannelNo, short ChannelNum)
		{
			int ret = DioStartPwm(Id, ChannelNo, ChannelNum);
			return ret;
		}

		public int StopPwm(short Id, short[] ChannelNo, short ChannelNum)
		{
			int ret = DioStopPwm(Id, ChannelNo, ChannelNum);
			return ret;
		}

		public int GetPwmStatus(short Id, short[] ChannelNo, short ChannelNum, ushort[] Status, ushort[] Error)
		{
			int ret = DioGetPwmStatus(Id, ChannelNo, ChannelNum, Status, Error);
			return ret;
		}

		public int GetMaxPulseMeasurementChannels(short Id, out ushort ChannelNum)
		{
			ChannelNum = 0;
			int ret = DioGetMaxPulseMeasurementChannels(Id, ref ChannelNum);
			return ret;
		}

		public int SetPulseMeasurementSetting(short Id, short[] ChannelNo, short ChannelNum, ushort[] MeasurementTarget, ushort[] PulsePeriod)
		{
			int ret = DioSetPulseMeasurementSetting(Id, ChannelNo, ChannelNum, MeasurementTarget, PulsePeriod);
			return ret;
		}

		public int GetPulseMeasurementSetting(short Id, short[] ChannelNo, short ChannelNum, ushort[] MeasurementTarget, ushort[] PulsePeriod)
		{
			int ret = DioGetPulseMeasurementSetting(Id, ChannelNo, ChannelNum, MeasurementTarget, PulsePeriod);
			return ret;
		}

		public int StartPulseMeasurement(short Id, short[] ChannelNo, short ChannelNum)
		{
			int ret = DioStartPulseMeasurement(Id, ChannelNo, ChannelNum);
			return ret;
		}

		public int StopPulseMeasurement(short Id, short[] ChannelNo, short ChannelNum)
		{
			int ret = DioStopPulseMeasurement(Id, ChannelNo, ChannelNum);
			return ret;
		}

		public int ReadPulseMeasurementData(short Id, short[] ChannelNo, short ChannelNum, ushort[] Status, ushort[] Error, ulong[] TimeValue, ushort[] TimeUnit)
		{
			int ret = DioReadPulseMeasurementData(Id, ChannelNo, ChannelNum, Status, Error, TimeValue, TimeUnit);
			return ret;
		}
		...
		public int DmSetStopEvent(short Id, short Direction, IntPtr hWnd)
		{
		...
		public int DmSetCountEvent(short Id, short Direction, uint Count, IntPtr hWnd)
		{
